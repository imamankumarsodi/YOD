    ...
    func customPageControl() {
        for (pageIndex, dotView) in self.subviews.enumerated() {
            if self.currentPage == 0 {
                ...
                dotView.backgroundColor = #colorLiteral(red: 0.6265287399, green: 0.2559435964, blue: 0.05190247297, alpha: 1)
                dotView.layer.cornerRadius = dotView.frame.size.height / 2
            }else if self.currentPage == 1{
                dotView.backgroundColor = #colorLiteral(red: 0.9204772115, green: 0.07135304064, blue: 0.5468947887, alpha: 1)
                dotView.layer.cornerRadius = dotView.frame.size.height / 2
            }else if self.currentPage == 2{
                dotView.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
                dotView.layer.cornerRadius = dotView.frame.size.height / 2
            }else if self.currentPage == 3{
                dotView.backgroundColor = #colorLiteral(red: 0.6672585011, green: 0.6587713957, blue: 0.6547486186, alpha: 1)
                dotView.layer.cornerRadius = dotView.frame.size.height / 2
            }
        }
    }
